...
export const movieReviewAdd = review => {
    return dispatch => {
        ...
        axios.post("/review/addReview/", review)
             .then(response =>{
...
export const movieReviewEdit = review => {
    return dispatch => {
        dispatch(movieReviewEditStart());

        axios.patch("/review/updateReview/", review)
             .then(response => {
...
export const movieReviewGet = movieId => {
    return dispatch => {
        ...
        axios.get("/review/getReview/" + movieId)
             .then(response => {
...
export const movieReviewsGet = movieId => {
    return dispatch => {
        ...
        axios.get("/review/getReviews/" + movieId)
             .then(response => {
...
export const movieReviewDelete = reviewId => {
    return dispatch => {
        ...
        axios.delete("/review/deleteReview/" + reviewId)
             .then(response => {
